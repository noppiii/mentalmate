...
@section('title')
    Kategori Artikel | {{ config('app.name') }}
@endsection
@section('pages')
    Kategori Artikel Admin
@endsection
@section('content')
                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p>Di sini Anda dapat mengontrol dan mengelola semua aspek kategori artikel</p>
            ...
            <div class="col-lg-8 mb-4 col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">Statistics Kategori Artikel</h5>
                            ...
                            <div class="col-md-8 col-6">
                                <div class="d-flex align-items-center">
                                    <div class="badge rounded-pill bg-label-success me-3 p-2">
                                        <i class="ti ti-category-2 ti-sm"></i>
                                    </div>
                                    <div class="card-info">
                                        <h5 class="mb-0 text-success">{{$newCategory->nama}}
                    ...
                    <div class="row h-100">
                        ...
                        <div class="col-sm-7">
                            <div class="card-body text-sm-end text-center ps-sm-0">
                                <a href="{{ route('kategori-artikel.create') }}"
                                   class="btn btn-primary mb-2 text-nowrap add-new-role d-block"
                                >
                                    + Kategori
                                </a>
                                <small class="mb-0 mt-1 d-block">Tambah kategori artikel</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-datatable table-responsive pt-0">
                        <table class="datatables-fakultas table">
                            ...
                            <tbody>
                            <?php $no = 1; ?>
                            @foreach($allKategoriBerita as $data)
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td>{{ $data->id }}</td>
            ...
            >
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content text-center">
                        ...
                        <form method="POST" action="{{ route('kategori-artikel.destroy', $data->id) }}">
                            @csrf
                            @method('DELETE')
