...
@section('title')
    Buat Kategori Artikel | {{ config('app.name') }}
@endsection
@section('pages')
        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
              <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                  <div class="card-body">
                    <h5 class="text-primary">Tambah Kategori berita</h5>
                    <p>Di sini anda dapat menambahkan user sebagai kategori berita</p>
         ...
         <div class="card mb-4">
             <form class="card-body" action="{{ route('kategori-artikel.store') }}" method="post" enctype="multipart/form-data">
                @csrf
              <div class="row g-3">
