...
@section('title')
    Edit Tag Artikel | {{ config('app.name') }}
@endsection
@section('pages')
    Edit Tag Artikel Admin
@endsection
@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="col-lg-12 mb-4 order-0">
         ...
         <div class="card mb-4">
             <form class="card-body" action="{{ route('tag-artikel.update', $tag->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              <div class="row g-3">
                <div class="row mb-3 mt-4">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div id="full-editor">{!! $tag->content !!}</div>
                        <textarea id="content" name="content" style="display:none;">{{ $tag->content }}</textarea>
                    </div>
                </div>
              </div>
              <div class="pt-4">
