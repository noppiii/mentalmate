                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p>Di sini Anda dapat mengontrol dan mengelola semua aspek tag artikel</p>
            ...
            <div class="col-lg-8 mb-4 col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">Statistics Tag Artikel</h5>
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-md-8 col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="card-info">
                                        <h5 class="mb-0 text-success">{{$newTag->nama}}

                                        </h5>
                                        <small>Tag Baru</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row h-100">
                        ...
                        <div class="col-sm-7">
                            <div class="card-body text-sm-end text-center ps-sm-0">
                                <a href="{{ route('tag-artikel.create') }}"
                                   class="btn btn-primary mb-2 text-nowrap add-new-role d-block"
                                >
                                    + Tag
                                </a>
                                <small class="mb-0 mt-1 d-block">Tambah tag artikel</small>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td>
                                        <div class="d-inline-block">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end m-0">'
                                                ...
                                                <a href="{{ route('tag-artikel.edit', $data->id) }}"
            ...
            >
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content text-center">
                        ...
                        <form method="POST" action="{{ route('tag-artikel.destroy', $data->id) }}">
                            @csrf
                            @method('DELETE')
