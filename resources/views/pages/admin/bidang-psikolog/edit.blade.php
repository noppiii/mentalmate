...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="col-lg-12 mb-4 order-0">
         ...
         <div class="card mb-4">
             <form class="card-body" action="{{ route('bidang-psikolog.update', $bidang->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              <div class="row g-3">
                <div class="row mb-3 mt-4">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div id="full-editor">{!! $bidang->description !!}</div>
                        <textarea id="description" name="description" style="display:none;">{{ $bidang->description }}</textarea>
                    </div>
                </div>
              </div>
              <div class="pt-4">
