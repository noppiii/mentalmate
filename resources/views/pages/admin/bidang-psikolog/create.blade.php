...
@section('title')
    Buat Bidang Psikolog | {{ config('app.name') }}
@endsection
@section('pages')
    Buat Bidang Psikolog Admin
@endsection
@section('content')
        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
              <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                  <div class="card-body">
                    <h5 class="text-primary">Tambah Bidang Psikolog</h5>
                    <p>Di sini anda dapat menambahkan bidang psikolog</p>
         ...
         <div class="card mb-4">
             <form class="card-body" action="{{ route('bidang-psikolog.store') }}" method="post" enctype="multipart/form-data">
                @csrf
              <div class="row g-3">
