...
@section('title')
    Bidang Psikolog | {{ config('app.name') }}
@endsection
@section('pages')
    Bidang Psikolog Admin
@endsection
@section('content')
                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p>Di sini Anda dapat mengontrol dan mengelola semua aspek bidang psikolog</p>
                            ...
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <h4 class="mb-0 me-2">{{$totalBidang}}</h4>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <h6 class="mb-0 me-2">{{$bidangPsikologTerbanyak->name}}</h6>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <h6 class="mb-0 me-2">{{$bidangPsikologTerfavorit->name}}</h6>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <a href="{{ route('bidang-psikolog.create') }}" class="btn btn-primary mt-2">+
                                            Bidang</a>
                                    </div>
                                    {{-- <small>&nbsp;</small> --}}
                                </div>
