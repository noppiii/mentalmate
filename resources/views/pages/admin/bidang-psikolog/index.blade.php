              ...
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between">
                  <div class="content-left">
                    ...
                    <small>Total Bidang Psikolog</small>
                  </div>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between">
                  <div class="content-left">
                    <span>Bidang Psikolog</span>
                    <div class="d-flex align-items-center my-1">
                      <h4 class="mb-0 me-2">4,567</h4>
                      <span class="text-success">(+18%)</span>
                    </div>
                    <small>Psikolog Terbanyak</small>
                  </div>
              ...
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between">
                  <div class="content-left">
                    ...
                    <small>Bidang Psikolog Favorit</small>
                  </div>
              ...
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between">
                  <div class="content-left">
                    ...
                    <div class="d-flex align-items-center my-1">
                      <a href="{{ route('bidang-psikolog.create') }}" class="btn btn-primary mt-2">+ Bidang</a>
                    </div>
                    {{-- <small>&nbsp;</small> --}}
                  </div>
                  <span class="badge bg-label-primary rounded p-2">
                    ...
                    <li class="list-inline-item">
                      <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                          <li><a class="dropdown-item" href="{{ route('bidang-psikolog.edit', $data->id) }}"><i class="ti ti-pencil me-2"></i>Edit Bidang</a></li>
                          <li>
                            <hr class="dropdown-divider" />
                          </li>
                          <li>
                            <button class="dropdown-item text-danger"  data-bs-toggle="modal" data-bs-target="#onboardHorizontalImageModal{{ $data->id }}"><i class="ti ti-trash me-2"></i>Delete Bidang</button>
                          </li>
                        </ul>
                      </div>
                    </li>
