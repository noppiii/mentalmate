        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
              <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                  <div class="card-body">
                    <h5 class="text-primary">Tambah Banner</h5>
                    <p>Di sini anda dapat menambahkan user sebagai Banner</p>
         ...
         <div class="card mb-4">
            <form class="card-body" action="{{ route('banner.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="row mb-3 mt-4">
                        <label class="col-sm-2 form-label" for="basic-icon-default-email">Judul Banner</label>
                        <div class="col-sm-10">
                ...
                <div class="row g-3">
                    <div class="row mb-3 mt-4">
                        <label class="col-sm-2 form-label" for="basic-icon-default-email">Link</label>
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                ...
                <div class="row g-3">
                    <div class="row mb-3 mt-4">
                        <label class="col-sm-2 form-label" for="basic-icon-default-email">Banner</label>
                        <div class="col-sm-10">
