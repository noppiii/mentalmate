        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
              <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                  <div class="card-body">
                    <h5 class="text-primary">Tambah Psikolog</h5>
                    <p>Di sini anda dapat menambahkan user sebagai psikolog</p>
         ...
         <div class="card mb-4">
             <form class="card-body" action="{{ route('psikolog.store') }}" method="post" enctype="multipart/form-data">
                @csrf
              <h6>1. Detail Akun</h6>
              <div class="row g-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            <input type="file" class="form-control" name="profile_photo_path" id="inputGroupFile02" accept="image/*" />
