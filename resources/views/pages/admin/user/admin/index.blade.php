              ...
              <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                  <div class="card-body">
                    ...
                    <p>Di sini Anda dapat mengontrol dan mengelola semua aspek admin</p>
                      ...
                      <div class="row h-100">
                        ...
                        <div class="col-sm-7">
                          <div class="card-body text-sm-end text-center ps-sm-0">
                            ...
                            <small class="mb-0 mt-1 d-block">Tambah admin untuk manage resource</small>
                          </div>
                        </div>
                      </div>
                    </div>
                          ...
                          <tr>
                              ...
                              <td>
                                <div class="avatar avatar-md">
                                    <img src="{{ asset('store/user/photo/admin/' . $data->profile_photo_path) }}" alt="Avatar" class="rounded-circle" />
                                  </div>
                              </td>
                              <td>
                                  ...
                                  <a href="{{ route('admin.edit', $data->id) }}" class="dropdown-item"><i class="ti ti-pencil me-1"></i>Edit</a>
