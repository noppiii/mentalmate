...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="col-lg-12 mb-4 order-0">
              ...
              <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                  <div class="card-body">
                    ...
                    <p>Di sini anda dapat mengubah informasi admin</p>
                ...
                <div class="col-sm-5 text-center text-sm-left">
                  <div class="card-body pb-0 px-0 px-md-4">
                    <img
                      src="{{ asset('image/edit-admin.jpg') }}"
                      height="150"
                      alt="View Badge User"
         ...
         <div class="card mb-4">
            <form class="card-body" action="{{ route('admin.update', $admin->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              <h6>1. Detail Akun</h6>
              <div class="row g-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="avatar avatar-xl mt-2">
                            <img src="{{ asset('store/user/photo/admin/' . $admin->profile_photo_path) }}" alt="Avatar" class="rounded-circle" />
                          </div>
                         @else
