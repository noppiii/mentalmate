            ...
            <div class="swiper-slider" data-autoplay="true" data-loop="true" data-dots="true" data-arrows="false"
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="pbmit-slider-item">
                            ...
                            <div class="container">
                                <div class="row text-center">
                                    <div class="col-md-12">
                                        <div class="pbmit-slider-content">
                                            <h5 class="pbmit-sub-title transform-top transform-delay-1">Tradition.
                                                Quality. Progress.</h5>
                                            <h2 class="pbmit-title transform-bottom transform-delay-2">Driving
                                                Innovation <br> <strong>To Wellness</strong></h2>
                                            <div class="pbmit-button transform-bottom transform-delay-3">
                                                <a class="pbmit-btn pbmit-btn-outline" href="about-us.html">
														<span class="pbmit-button-content-wrapper">
															<span class="pbmit-button-icon pbmit-align-icon-right">
                    ...
                    <div class="swiper-slide">
                        <div class="pbmit-slider-item">
                            <div class="pbmit-slider-bg"
                                 style="background-image: url({{ asset('client/images/demo01-slide-03.jpg') }});"></div>
                            <div class="container">
                                <div class="row text-center">
                                    <div class="col-md-12">
                                        <div class="pbmit-slider-content">
                                            <h5 class="pbmit-sub-title transform-top transform-delay-1">The Future of
                                                Healthcare</h5>
                                            <h2 class="pbmit-title transform-bottom transform-delay-2">Doctors Obsolete
                                                <br> <strong>Healthcare</strong></h2>
                                            <div class="pbmit-button transform-bottom transform-delay-3">
                                                <a class="pbmit-btn pbmit-btn-outline" href="about-us.html">
														<span class="pbmit-button-content-wrapper">
															<span class="pbmit-button-icon pbmit-align-icon-right">
                    ...
                    <div class="col-md-6 col-lg-4 position-relative">
                        ...
                        <div class="inner-box_style inner-box_2">
                            ...
                            <div class="pbmit-text_aditor">
                                Search our locations to find the one nearest you Get the answers and assurance you
                                deserve with accuracy you can trust.
                            </div>
                        ...
                        <div class="col-md-7 about-us-two_col2 pbmit-sticky-col2-special">
                            <div class="about-us-two_rightbox">
                                ...
                                <div class="about-us-two_innerbox">
                                    <div>Despite a robust ecosystem of its own, does not exist in isolation. It
                                        integrates with other services and systems intended to enhance the community’s
                                        health and emergency management and public safety.
                                    </div>
                                    <div class="pbmit-ihbox-style-12">
                                        <div class="pbmit-ihbox-box d-flex align-items-center">
                                            ...
                                            <div class="pbmit-ihbox-contents">
                                                ...
                                                <div class="pbmit-heading-desc">This site includes an overview of how
                                                    infections spread, ways to prevent the spread of infections
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="pbmit-ihbox-style-12">
                                        <div class="pbmit-ihbox-box d-flex align-items-center">
                                            ...
                                            <div class="pbmit-ihbox-contents">
                                                ...
                                                <div class="pbmit-heading-desc">Another part of preventive health is
                                                    learning to recognize changes in your body that may not be normal
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="img_box">
                                        <img src="{{ asset('client/images/about-img-03.jpg') }}" class="img-fluid"
                                             alt="">
                                    </div>
                                    ...
                                    <div>Digital Opration is a technique used for thousands of years to develop
                                        awareness of the present moment, It can involve practices to sharpen focus and
                                        attention
                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <ul class="list-group list-group-borderless">
                                                    <li class="list-group-item">
                                                        ...
                                                        <span
                                                            class="pbmit-icon-list-text">Avoid ultra-processed foods</span>
                                                    </li>
                                                    <li class="list-group-item">
															<span class="pbmit-icon-list-icon">
																<i aria-hidden="true" class="ti-check"></i>
                                                        ...
                                                        <span
                                                            class="pbmit-icon-list-text">Don’t eat heavily meats</span>
                                                    </li>
                                                    <li class="list-group-item">
															<span class="pbmit-icon-list-icon">
																<i aria-hidden="true" class="ti-check"></i>
                                                        ...
                                                        <span
                                                            class="pbmit-icon-list-text">Minimize your sugar intake</span>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-md-6">
                                                <ul class="list-group list-group-borderless">
                                                    ...
                                                    <li class="list-group-item">
                                                        ...
                                                        <span
                                                            class="pbmit-icon-list-text">Avoid harmful use of alcohol</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
            ...
            <div class="container">
                ...
                <div class="pbmit-tab">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#tab-2-4" aria-selected="false" role="tab"
                               tabindex="-1">
                            ...
                            <div class="pbmit-column-inner">
                                <div class="row g-0 align-items-center">
                                    ...
                                    <div class="col-md-12 col-xl-6 pbmit-tab-list">
                                        ...
                                        <div>There are many variations of passages of Lorem Ipsum available, but the
                                            majority have suffered alteration in some form, by injected humour, or
                                            randomised words which don't look even. Quis ipsum suspendisse ultrices
                                        ...
                                        <ul class="list-group list-group-borderless">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <span
                                                    class="pbmit-icon-list-text">Instant Operation & Appointment</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
