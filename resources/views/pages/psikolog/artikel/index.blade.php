    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row g-4 mb-4">
                            ...
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <h4 class="mb-0 me-2">{{$totalArtikel}}</h4>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <h4 class="mb-0 me-2">{{$pendingArtikel}}</h4>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <h4 class="mb-0 me-2">{{$rejectedArtikel}}</h4>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="content-left">
                                    ...
                                    <div class="d-flex align-items-center my-1">
                                        <a href="{{ route('my-artikel.create') }}" class="btn btn-primary mt-2">+
                                            Artikel</a>
                                    </div>
                                    {{-- <small>&nbsp;</small> --}}
                                </div>
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <form action="{{route('my-artikel.index')}}" method="GET">
                            ...
                            <div class="card">
                                    ...
                                    <div class="d-flex align-items-start">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="me-2 ms-1">
                                                <h5 class="mb-0">
                                                    <a href="javascript:;"
                                                       class="stretched-link text-body">{{ implode(' ', array_slice(str_word_count($data->name, 1), 0, 4)) }}</a>
                                                </h5>
                                                <div class="client-info">
                                                    <strong>Pembuat: </strong><span
                                                        class="text-muted">{{ $data->psikolog->nama }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="ms-auto">
                                            <div class="dropdown zindex-2">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item" data-bs-toggle="modal"
                                                           ...
                                                           href="javascript:void(0);">View Artikel</a></li>
                                                    <li><a class="dropdown-item"
                                                           href="{{ route('my-artikel.edit', $data->id) }}">Edit
                                                            Artikel</a></li>
                                                    <li>
                                ...
                                <div class="card-body border-top">
                                    <div class="d-flex align-items-center mb-3">
                                        <h6 class="mb-1">Tanggal Dibuat: <span
                                                class="text-body fw-normal">{{ \Carbon\Carbon::parse($data->created_at)->translatedFormat('d F Y') }}</span>
                                        </h6>
                                    </div>
                                    {{-- <div class="d-flex align-items-center mb-3">
                                        <h6 class="mb-1">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <h6 class="mb-1">Status:
                                            @if($data->status === 'accepted')
                                                <span
                                                    class="badge bg-label-success fw-normal me-2">{{ $data->status }}</span>
                                            @elseif($data->status === 'pending')
                                                <span
                                                    class="badge bg-label-warning fw-normal me-2">{{ $data->status }}</span>
                                            @elseif($data->status === 'rejected')
                                                <span
                                                    class="badge bg-label-danger fw-normal me-2">{{ $data->status }}</span>
                                            @endif
                                        </h6>
                                    </div>
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="ms-auto">
                                            ...
                                            ><i class="ti ti-message-dots ti-sm"></i> {{ $data->comments->count() }} Comment</a
                                            >
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row mt-4">
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $artikels->previousPageUrl() }}" aria-label="Previous">
                        ...
                        <!-- Tombol Halaman -->
                        @php
                            $start = max($artikels->currentPage() - 2, 1);
                            $end = min($start + 4, $artikels->lastPage());
