  ...
  <body>
    ...
    <div class="authentication-wrapper authentication-cover authentication-bg">
      <div class="authentication-inner row">
        ...
        >
          <img
            src="{{ asset('image/register-psikolog.png') }}"
                ...
                <div id="personalInfoValidation" class="content">
                  <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                      ...
                      <select id="multiStepsGender" name="jenis_kelamin" class="select2JenisKelamin form-select" data-allow-clear="true" required>
                    ...
                    <div class="col-md-6 col-12">
                      ...
                      <input type="text" class="form-control" name="tanggal_lahir" placeholder="YYYY-MM-DD" id="flatpickr-date" required />
                    </div>
                    <div class="col-md-12">
                ...
                <div id="billingLinksValidation" class="content">
                  <div class="row g-3">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="input-group">
                        <input type="file" name="profile_photo_path" class="form-control" id="multiStepsFoto" />
                        <label class="input-group-text" for="multiStepsFoto">Upload</label>
                      </div>
                    </div>
                    <div class="col-12 d-flex justify-content-between mt-4">
